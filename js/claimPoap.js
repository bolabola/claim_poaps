...
const claim_url = 'https://anyplace-cors.herokuapp.com/https://frontend.poap.tech/actions/claim-qr'
            ...
            if (link) {
                ...
                for(let address of addresses){
                    let params = {
                        address:address,
                        qr_hash:qr_hash,
                        secret:"2a61c3da5d19ba7ab73065561b1e2055e23b8617dc761c4e9af54402d838b8fe"
                    }
                    let o = await synchronous_request(claim_url,params)
                    console.log(o)
                }
